...
const (
	MsgRcvCounterName = "ngap_msg_received_total"
	MsgRcvCounterDesc = "Total number of received NGAP message"

	MsgSentCounterName = "ngap_msg_sent_total"
	MsgSentCounterDesc = "Total number of NGAP message sent"
)
